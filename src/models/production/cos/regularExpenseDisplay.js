...
export default {
  namespace: 'regularExpenseDisplay',
  ...
  effects: {
    *init({ payload }, { put, select }) {
      const {
        formData: { id },
        copy = false,
      } = yield select(({ regularExpenseDisplay }) => regularExpenseDisplay);
    ...
    *fetchConfig({ payload }, { call, put }) {
      ...
      if (taskKey === 'S01_01_SUBMIT_i') {
        ...
        taskKey === 'S01_07_FINANCE_MANGER' ||
        taskKey === 'S01_08_FINANCE_IN_CHARGE' ||
        taskKey === 'S01_06_AUDITING' ||
        taskKey === 'S01_06_PROJECT_ACCOUNTING'
      ) {
        formMode = 'EDIT';

...
// @ts-ignore
import {reportBuSelectPaging,} from '@/services/production/common/select';
 ...
 * 2.
 */
class BuReportSelect extends React.Component<Props, any> {
  ...
  getData = async () => {
    ...
    const output: OutputProps = await outputHandle(reportBuSelectPaging, {...queryParam,limit:0,buStatus:'ACTIVE'});

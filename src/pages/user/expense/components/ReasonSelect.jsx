  ...
  onSearch = value => {
    ...
    switch (type) {
      case '01': {
        ...
        reasonList = { ...reasonList, reasonCode: projectList.valCode }; // 返回reasonCode
        break;
      }
      case '02': {
        // 售前任务
        reasonList = preSaleTaskList;
        reasonList = { ...reasonList, reasonCode: preSaleTaskList.valCode };
        break;
      }
      case '03': {
        // bu任务
        reasonList = buTaskList;
        reasonList = { ...reasonList, reasonCode: buTaskList.valCode };
        break;
      }
      case '04': {
        // 合同
        reasonList = contractList;
        reasonList = { ...reasonList, reasonCode: contractList.code };
        break;
      }
      default: {
        reasonList = [];

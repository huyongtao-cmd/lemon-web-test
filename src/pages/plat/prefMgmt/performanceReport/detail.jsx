...
class PerformanceReportDetail extends React.PureComponent {
  state = {
  ...
  render() {
    ...
    return (
      <PageWrapper loading={loading}>
        ...
        <Card title="年中述职" bordered={false}>
          <DataTable
        ...
        <Card title="年度工作总结" bordered={false} style={{ marginTop: '2px' }}>
          <div
        ...
        />
        <Card title="支持与帮助" bordered={false} style={{ marginTop: '2px' }}>
          <div
            style={{ padding: '15px', overflow: 'hidden', overflowY: 'scroll' }}
            className={styles.paper}
            dangerouslySetInnerHTML={{ __html: expectedSupport }}
          />
        </Card>
        <Card
          title="领导整体评价及建议"

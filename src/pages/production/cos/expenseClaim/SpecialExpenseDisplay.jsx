...
// namespace声明
const DOMAIN = 'specialExpenseDisplay';
 ...
 * 常规报销 综合展示页面
 */
@connect(({ loading, dispatch, specialExpenseDisplay, user: { user } }) => ({
...
class SpecialExpenseDisplay extends React.PureComponent {
  state = {
    visible: false,
  };
  ...
  render() {
    ...
    const diabledView = taskKey === 'COS05_04_AUDITING';
    // 处理申请人修改节点的按钮
    ...
    // 其他流程
    const allBpm = [{ docId: formData.id, procDefKey: procKey, title: '特殊费用报销流程' }];
    ...
    const editColumns = [
      ...
      //         fieldKey={`details[${index}].projectExpense`}
      //         options={financialAccSubjList}
      //       />
      //     ),
      // },
        ...
        <BpmWrapper
          ...
          onBtnClick={({ operation, bpmForm }) => {
            ...
            if (
              ...
              if (taskKey === 'COS05_04_AUDITING' && key === 'FLOW_PASS') {
...
export default SpecialExpenseDisplay;

...
import { collectionSaveRq, collectionPagingRq } from '@/services/production/interface';
...
class index extends Component {
  ...
  modifyData = async params => {
    ...
    const { response } = await collectionSaveRq(selectedRows);
    return response;
  };
  ...
  handleCancel = e => {
    ...
    if (isNil(e)) {
      closeThenGoto(`/plat/interface/collection?refresh=${genFakeId(-1)}`);
    }
  };

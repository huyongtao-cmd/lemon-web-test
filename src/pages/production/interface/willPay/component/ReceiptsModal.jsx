...
import { willPaySaveRq } from '@/services/production/interface';
...
class index extends Component {
  ...
  modifyData = async params => {
    ...
    const { response } = await willPaySaveRq(selectedRows);
    return response;
  };
  ...
  handleCancel = e => {
    ...
    if (isNil(e)) {
      closeThenGoto(`/plat/interface/willPay?refresh=${genFakeId(-1)}`);
    }
  };

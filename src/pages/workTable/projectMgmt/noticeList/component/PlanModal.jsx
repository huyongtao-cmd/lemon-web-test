...
class PlanModal extends React.Component {
  ...
  fetchData = async params => {
    ...
    const tt = response.data.rows
      .map(v => ({ ...v, children: null }))
      .filter(row => row.executeStatus !== 'CANCELED' && row.executeStatus !== 'FINISHED');
  ...
  renderColumns = () => {
    const fields = [
      ...
      },
      {
        ...
        //   }
        //   const data = isNaN(value) ? value : parseInt(value);

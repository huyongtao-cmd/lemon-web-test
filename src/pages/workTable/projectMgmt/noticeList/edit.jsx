...
const DOMAIN = 'noticeListEdit';

@connect(({ loading, noticeListEdit, dispatch }) => ({
  loading,
  ...noticeListEdit,
  dispatch,
}))
...
class indexCom extends Component {
  ...
  handleSave = issueFlag => {
    ...
    validateFieldsAndScroll((error, values) => {
      if (!error) {
        // const list = projectAllMemberList.filter(item => {
        ...
        dispatch({
          ...
          payload: {
            ...
            projectId,
            phaseId,
            memberEntities: projectMemberList,
  ...
  swapItems = (arr, index1, index2) => {
    ...
    const tt = arr.map((v, index) => ({ ...v, sortNo: index + 1 }));
  ...
  render() {
    ...
    const subscript = relatedRowSelectionSelected.map(v => v.id);
    const disabledBtn =
                  ...
                  ? () => (
                      ...
                      <>
                        ...
                        <Button
                          key="up"
                          type="primary"
                          disabled={relatedRowSelectionSelected.length !== 1}
                          onClick={() => {
                            let targetIndex;
                            relatedPlanList.forEach((item, index) => {
                              if (item.id === subscript[0]) {
                                targetIndex = index;
                              }
                            });
                            this.upRecord(relatedPlanList, targetIndex);
                          }}
                        >
                          上移
                        </Button>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            ...
                            this.downRecord(relatedPlanList, targetIndex);
                          }}
                        >
                          下移
                        </Button>
